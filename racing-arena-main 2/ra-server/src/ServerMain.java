...
public class ServerMain {
    ...
    private static void initServerGUI() {
        ...
        try {
//            System.out.println(new File("assets/dog-russel-grin-icon.png").getCanonicalPath());
            jFrame.setIconImage(ImageIO.read(new File("ra-server/assets/dog-russel-grin-icon.png")));
        } catch (IOException e) {
            e.printStackTrace();
        }
